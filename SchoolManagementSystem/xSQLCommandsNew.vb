...
Module xSQLCommandsNew
    ...
    Function xReturnMaxVal(ByVal tableName As String, ByVal colName As String, ByVal xControls As Windows.Forms.Control)

        Dim sql As String
        Dim returnVal As String = ""
        Dim i As Integer

        sql = "SELECT max(" & colName & ") + 1 as MaxID FROM " & tableName
